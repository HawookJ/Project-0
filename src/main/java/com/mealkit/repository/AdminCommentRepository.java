...
import com.mealkit.domain.post.admin.AdminComment;
import com.mealkit.domain.post.admin.QAdminComment;
...
public interface AdminCommentRepository extends JpaRepository<AdminComment,Long>,
        QuerydslPredicateExecutor<AdminComment> //기본검색기능
   , QuerydslBinderCustomizer<QAdminComment>
{
    @Override
    default void customize(QuerydslBindings bindings, QAdminComment root){ //직접 구현체 만들지 않고 인터페이스만 가지고?
